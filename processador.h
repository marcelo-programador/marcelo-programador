...
/*
Função responsável por chamar todas as funções do simulador de processador que recebe txt contendo binários e atualizar o PC
entrada: não tem
saída: não tem
*/
...
entrada: referência para lista de entradas l, inteiro i, referência para inteiro PC
saída: não tem
*/
void alteracao_pc_bin(lista_entradas *l, int i, int *PC);

/*
Função que com base no tipo da instrução, pega cada parte do código de máquina e salva nos registradores necessários
...
/*
Função responsável por preencher a lista de saídas com base nas instruções de entrada
...
entrada: referência para lista de entradas l, referência para lista de saídas s, inteiro i
saída: não tem
*/
...
/*
Função responsável por exibir a lista de instruções Assembly e suas saídas, além do PC
entrada: referência para lista de entradas l, referência para lista de saídas s, referência para PC
saída: não tem
*/
...
/*
Função responsável por inserir uma instrução na lista de entradas no formato binário
entrada: referência para lista de entradas l, instrução i
saída: não tem
*/
...
/*
Função responsável por imprimir as mudanças realizadas na memória durante a execução
entrada: referência para lista de entradas l, índice da instrução i
saída: não tem
*/
...
/*
Função responsável por contar o número de instruções presentes em um arquivo no formato binário
entrada: nome do arquivo
saída: número de instruções
*/
...
/*
Função responsável por definir o tipo de cada instrução na lista de entradas no formato binário
entrada: referência para lista de entradas l
saída: não tem
*/
...
/*
Função responsável por inicializar os registradores utilizados no formato binário
entrada: não tem
saída: não tem
*/
...
/*
Função responsável por atualizar o contador de programa (PC) com base na instrução atual
entrada: referência para lista de entradas l, índice da instrução i, ponteiro para PC
saída: não tem
*/
void alteracao_pc_bin(lista_entradas *l, int i, int *PC);

/*
Função responsável por alterar o valor de um registrador com base em uma instrução
entrada: referência para lista de entradas l, índice da instrução i
saída: verdadeiro (true) se a alteração foi bem-sucedida, falso (false) caso contrário
*/
bool alteracao_registrador_bin(lista_entradas *l, int i);

/*
Função responsável por realizar operações nos registradores com base em uma instrução
entrada: referência para lista de entradas l, índice da instrução i
saída: verdadeiro (true) se a operação foi bem-sucedida, falso (false) caso contrário
*/
bool operacoes_registradores_bin(lista_entradas *l, int i);
